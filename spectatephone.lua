...
ToggleButton.Size = UDim2.new(0.1, 0, 0.05, 0) -- Adjusts size based on screen
ToggleButton.Position = UDim2.new(0.01, 0, 0.9, 0) -- Left side, slightly above the bottom
...
Frame.Size = UDim2.new(0.3, 0, 0.2, 0) -- Adjusts size based on screen
Frame.Position = UDim2.new(0.5, -150, 0.4, 0) -- Centered on screen
Frame.AnchorPoint = Vector2.new(0.5, 0.5) -- Center anchor for better scaling
...
LeftButton.Position = UDim2.new(0, 0.05, 0.6, 0)
...
RightButton.Position = UDim2.new(0.7, -0.05, 0.6, 0)
